...
export const COMMANDS = [
  ...
  { cmd: 'logout',          desc: 'sign out and remove the saved Sennoric session and API key' },
  { cmd: 'usage',           desc: 'show your Sennoric plan, credits and usage limits  (alias: /account)' },
  { cmd: 'account',         desc: 'alias for /usage' },
  { cmd: 'credits',         desc: '[buy <amount> | redeem <code>]  show or add Sennoric credits' },
  { cmd: 'upgrade',         desc: 'open checkout for Sennoric Pro' },
  { cmd: 'billing',         desc: 'manage your Sennoric subscription in the browser' },
